...
worksheet.write(0,0,'简单迭代法计算实现线性方程组求根')
...
y4_1, y4_2, y4_3, y4_4= pow(2*x-5,1/3), (x**3-5)/2, 5/(x**2-2), pow((5/x)-2,0.5)
#每题可能或给定的公式
...
def diedai(result):#定义迭代功能函数，实现代码复用
    ...
    i += 1
    if float("inf") == float(n) or float("-inf") == float(n):#判断是否所得值已趋于无穷大，即发散
